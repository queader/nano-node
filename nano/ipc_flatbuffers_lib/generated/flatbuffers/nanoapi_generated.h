...
#ifndef FLATBUFFERS_GENERATED_NANOAPI_NANOAPI_H_
#define FLATBUFFERS_GENERATED_NANOAPI_NANOAPI_H_
...
template<> struct BlockTraits<nanoapi::BlockState> {
  static const Block enum_value = Block_BlockState;
};

template<> struct BlockTraits<nanoapi::BlockOpen> {
  static const Block enum_value = Block_BlockOpen;
};

template<> struct BlockTraits<nanoapi::BlockReceive> {
  static const Block enum_value = Block_BlockReceive;
};

template<> struct BlockTraits<nanoapi::BlockSend> {
  static const Block enum_value = Block_BlockSend;
};

template<> struct BlockTraits<nanoapi::BlockChange> {
...
struct BlockUnion {
  ...
  nanoapi::BlockStateT *AsBlockState() {
    return type == Block_BlockState ?
      reinterpret_cast<nanoapi::BlockStateT *>(value) : nullptr;
  }
  const nanoapi::BlockStateT *AsBlockState() const {
    return type == Block_BlockState ?
      reinterpret_cast<const nanoapi::BlockStateT *>(value) : nullptr;
  }
  nanoapi::BlockOpenT *AsBlockOpen() {
    return type == Block_BlockOpen ?
      reinterpret_cast<nanoapi::BlockOpenT *>(value) : nullptr;
  }
  const nanoapi::BlockOpenT *AsBlockOpen() const {
    return type == Block_BlockOpen ?
      reinterpret_cast<const nanoapi::BlockOpenT *>(value) : nullptr;
  }
  nanoapi::BlockReceiveT *AsBlockReceive() {
    return type == Block_BlockReceive ?
      reinterpret_cast<nanoapi::BlockReceiveT *>(value) : nullptr;
  }
  const nanoapi::BlockReceiveT *AsBlockReceive() const {
    return type == Block_BlockReceive ?
      reinterpret_cast<const nanoapi::BlockReceiveT *>(value) : nullptr;
  }
  nanoapi::BlockSendT *AsBlockSend() {
    return type == Block_BlockSend ?
      reinterpret_cast<nanoapi::BlockSendT *>(value) : nullptr;
  }
  const nanoapi::BlockSendT *AsBlockSend() const {
    return type == Block_BlockSend ?
      reinterpret_cast<const nanoapi::BlockSendT *>(value) : nullptr;
  }
  nanoapi::BlockChangeT *AsBlockChange() {
    return type == Block_BlockChange ?
      reinterpret_cast<nanoapi::BlockChangeT *>(value) : nullptr;
  }
  const nanoapi::BlockChangeT *AsBlockChange() const {
    return type == Block_BlockChange ?
      reinterpret_cast<const nanoapi::BlockChangeT *>(value) : nullptr;
  }
};
...
template<> struct MessageTraits<nanoapi::Error> {
  static const Message enum_value = Message_Error;
};

template<> struct MessageTraits<nanoapi::Success> {
  static const Message enum_value = Message_Success;
};

template<> struct MessageTraits<nanoapi::IsAlive> {
  static const Message enum_value = Message_IsAlive;
};

template<> struct MessageTraits<nanoapi::EventAck> {
  static const Message enum_value = Message_EventAck;
};

template<> struct MessageTraits<nanoapi::BlockInfo> {
  static const Message enum_value = Message_BlockInfo;
};

template<> struct MessageTraits<nanoapi::AccountWeight> {
  static const Message enum_value = Message_AccountWeight;
};

template<> struct MessageTraits<nanoapi::AccountWeightResponse> {
  static const Message enum_value = Message_AccountWeightResponse;
};

template<> struct MessageTraits<nanoapi::TopicConfirmation> {
  static const Message enum_value = Message_TopicConfirmation;
};

template<> struct MessageTraits<nanoapi::EventConfirmation> {
  static const Message enum_value = Message_EventConfirmation;
};

template<> struct MessageTraits<nanoapi::ServiceRegister> {
  static const Message enum_value = Message_ServiceRegister;
};

template<> struct MessageTraits<nanoapi::ServiceStop> {
  static const Message enum_value = Message_ServiceStop;
};

template<> struct MessageTraits<nanoapi::TopicServiceStop> {
  static const Message enum_value = Message_TopicServiceStop;
};

template<> struct MessageTraits<nanoapi::EventServiceStop> {
...
struct MessageUnion {
  ...
  nanoapi::ErrorT *AsError() {
    return type == Message_Error ?
      reinterpret_cast<nanoapi::ErrorT *>(value) : nullptr;
  }
  const nanoapi::ErrorT *AsError() const {
    return type == Message_Error ?
      reinterpret_cast<const nanoapi::ErrorT *>(value) : nullptr;
  }
  nanoapi::SuccessT *AsSuccess() {
    return type == Message_Success ?
      reinterpret_cast<nanoapi::SuccessT *>(value) : nullptr;
  }
  const nanoapi::SuccessT *AsSuccess() const {
    return type == Message_Success ?
      reinterpret_cast<const nanoapi::SuccessT *>(value) : nullptr;
  }
  nanoapi::IsAliveT *AsIsAlive() {
    return type == Message_IsAlive ?
      reinterpret_cast<nanoapi::IsAliveT *>(value) : nullptr;
  }
  const nanoapi::IsAliveT *AsIsAlive() const {
    return type == Message_IsAlive ?
      reinterpret_cast<const nanoapi::IsAliveT *>(value) : nullptr;
  }
  nanoapi::EventAckT *AsEventAck() {
    return type == Message_EventAck ?
      reinterpret_cast<nanoapi::EventAckT *>(value) : nullptr;
  }
  const nanoapi::EventAckT *AsEventAck() const {
    return type == Message_EventAck ?
      reinterpret_cast<const nanoapi::EventAckT *>(value) : nullptr;
  }
  nanoapi::BlockInfoT *AsBlockInfo() {
    return type == Message_BlockInfo ?
      reinterpret_cast<nanoapi::BlockInfoT *>(value) : nullptr;
  }
  const nanoapi::BlockInfoT *AsBlockInfo() const {
    return type == Message_BlockInfo ?
      reinterpret_cast<const nanoapi::BlockInfoT *>(value) : nullptr;
  }
  nanoapi::AccountWeightT *AsAccountWeight() {
    return type == Message_AccountWeight ?
      reinterpret_cast<nanoapi::AccountWeightT *>(value) : nullptr;
  }
  const nanoapi::AccountWeightT *AsAccountWeight() const {
    return type == Message_AccountWeight ?
      reinterpret_cast<const nanoapi::AccountWeightT *>(value) : nullptr;
  }
  nanoapi::AccountWeightResponseT *AsAccountWeightResponse() {
    return type == Message_AccountWeightResponse ?
      reinterpret_cast<nanoapi::AccountWeightResponseT *>(value) : nullptr;
  }
  const nanoapi::AccountWeightResponseT *AsAccountWeightResponse() const {
    return type == Message_AccountWeightResponse ?
      reinterpret_cast<const nanoapi::AccountWeightResponseT *>(value) : nullptr;
  }
  nanoapi::TopicConfirmationT *AsTopicConfirmation() {
    return type == Message_TopicConfirmation ?
      reinterpret_cast<nanoapi::TopicConfirmationT *>(value) : nullptr;
  }
  const nanoapi::TopicConfirmationT *AsTopicConfirmation() const {
    return type == Message_TopicConfirmation ?
      reinterpret_cast<const nanoapi::TopicConfirmationT *>(value) : nullptr;
  }
  nanoapi::EventConfirmationT *AsEventConfirmation() {
    return type == Message_EventConfirmation ?
      reinterpret_cast<nanoapi::EventConfirmationT *>(value) : nullptr;
  }
  const nanoapi::EventConfirmationT *AsEventConfirmation() const {
    return type == Message_EventConfirmation ?
      reinterpret_cast<const nanoapi::EventConfirmationT *>(value) : nullptr;
  }
  nanoapi::ServiceRegisterT *AsServiceRegister() {
    return type == Message_ServiceRegister ?
      reinterpret_cast<nanoapi::ServiceRegisterT *>(value) : nullptr;
  }
  const nanoapi::ServiceRegisterT *AsServiceRegister() const {
    return type == Message_ServiceRegister ?
      reinterpret_cast<const nanoapi::ServiceRegisterT *>(value) : nullptr;
  }
  nanoapi::ServiceStopT *AsServiceStop() {
    return type == Message_ServiceStop ?
      reinterpret_cast<nanoapi::ServiceStopT *>(value) : nullptr;
  }
  const nanoapi::ServiceStopT *AsServiceStop() const {
    return type == Message_ServiceStop ?
      reinterpret_cast<const nanoapi::ServiceStopT *>(value) : nullptr;
  }
  nanoapi::TopicServiceStopT *AsTopicServiceStop() {
    return type == Message_TopicServiceStop ?
      reinterpret_cast<nanoapi::TopicServiceStopT *>(value) : nullptr;
  }
  const nanoapi::TopicServiceStopT *AsTopicServiceStop() const {
    return type == Message_TopicServiceStop ?
      reinterpret_cast<const nanoapi::TopicServiceStopT *>(value) : nullptr;
  }
  nanoapi::EventServiceStopT *AsEventServiceStop() {
    return type == Message_EventServiceStop ?
      reinterpret_cast<nanoapi::EventServiceStopT *>(value) : nullptr;
  }
  const nanoapi::EventServiceStopT *AsEventServiceStop() const {
    return type == Message_EventServiceStop ?
      reinterpret_cast<const nanoapi::EventServiceStopT *>(value) : nullptr;
  }
};
...
inline flatbuffers::Offset<AccountWeight> CreateAccountWeightDirect(
  ...
  return nanoapi::CreateAccountWeight(
      _fbb,
      account__);
}
...
struct AccountWeightResponseT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.AccountWeightResponseT";
  }
...
struct AccountWeightResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.AccountWeightResponse";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_VOTING_WEIGHT = 4
  };
...
inline flatbuffers::Offset<AccountWeightResponse> CreateAccountWeightResponseDirect(
  ...
  return nanoapi::CreateAccountWeightResponse(
      _fbb,
      voting_weight__);
}
...
inline flatbuffers::Offset<BlockOpen> CreateBlockOpenDirect(
  ...
  return nanoapi::CreateBlockOpen(
      _fbb,
      hash__,
      account__,
      source__,
...
inline flatbuffers::Offset<BlockReceive> CreateBlockReceiveDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return nanoapi::CreateBlockReceive(
      _fbb,
      hash__,
      previous__,
      source__,
...
inline flatbuffers::Offset<BlockSend> CreateBlockSendDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return nanoapi::CreateBlockSend(
      _fbb,
      hash__,
      previous__,
      destination__,
...
inline flatbuffers::Offset<BlockChange> CreateBlockChangeDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return nanoapi::CreateBlockChange(
      _fbb,
      hash__,
      previous__,
      representative__,
...
struct BlockStateT : public flatbuffers::NativeTable {
  ...
  std::string signature{};
  std::string work{};
  nanoapi::BlockSubType subtype = nanoapi::BlockSubType_invalid;
};
...
struct BlockState FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  nanoapi::BlockSubType subtype() const {
    return static_cast<nanoapi::BlockSubType>(GetField<int8_t>(VT_SUBTYPE, 0));
  }
  bool mutate_subtype(nanoapi::BlockSubType _subtype) {
...
struct BlockStateBuilder {
  ...
  void add_subtype(nanoapi::BlockSubType subtype) {
...
inline flatbuffers::Offset<BlockState> CreateBlockStateDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return nanoapi::CreateBlockState(
      _fbb,
      hash__,
      account__,
      previous__,
...
struct BlockInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.BlockInfo";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_BLOCK_TYPE = 4,
    VT_BLOCK = 6
  };
  nanoapi::Block block_type() const {
    return static_cast<nanoapi::Block>(GetField<uint8_t>(VT_BLOCK_TYPE, 0));
  }
  const void *block() const {
    return GetPointer<const void *>(VT_BLOCK);
  }
  template<typename T> const T *block_as() const;
  const nanoapi::BlockState *block_as_BlockState() const {
    return block_type() == nanoapi::Block_BlockState ? static_cast<const nanoapi::BlockState *>(block()) : nullptr;
  }
  const nanoapi::BlockOpen *block_as_BlockOpen() const {
    return block_type() == nanoapi::Block_BlockOpen ? static_cast<const nanoapi::BlockOpen *>(block()) : nullptr;
  }
  const nanoapi::BlockReceive *block_as_BlockReceive() const {
    return block_type() == nanoapi::Block_BlockReceive ? static_cast<const nanoapi::BlockReceive *>(block()) : nullptr;
  }
  const nanoapi::BlockSend *block_as_BlockSend() const {
    return block_type() == nanoapi::Block_BlockSend ? static_cast<const nanoapi::BlockSend *>(block()) : nullptr;
  }
  const nanoapi::BlockChange *block_as_BlockChange() const {
    return block_type() == nanoapi::Block_BlockChange ? static_cast<const nanoapi::BlockChange *>(block()) : nullptr;
  }
  void *mutable_block() {
...
template<> inline const nanoapi::BlockState *BlockInfo::block_as<nanoapi::BlockState>() const {
  return block_as_BlockState();
}

template<> inline const nanoapi::BlockOpen *BlockInfo::block_as<nanoapi::BlockOpen>() const {
  return block_as_BlockOpen();
}

template<> inline const nanoapi::BlockReceive *BlockInfo::block_as<nanoapi::BlockReceive>() const {
  return block_as_BlockReceive();
}

template<> inline const nanoapi::BlockSend *BlockInfo::block_as<nanoapi::BlockSend>() const {
  return block_as_BlockSend();
}

template<> inline const nanoapi::BlockChange *BlockInfo::block_as<nanoapi::BlockChange>() const {
...
struct BlockInfoBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_block_type(nanoapi::Block block_type) {
...
inline flatbuffers::Offset<BlockInfo> CreateBlockInfo(
    flatbuffers::FlatBufferBuilder &_fbb,
    nanoapi::Block block_type = nanoapi::Block_NONE,
...
struct ServiceRegisterT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.ServiceRegisterT";
  }
...
struct ServiceRegister FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.ServiceRegister";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SERVICE_NAME = 4
  };
...
inline flatbuffers::Offset<ServiceRegister> CreateServiceRegisterDirect(
  ...
  return nanoapi::CreateServiceRegister(
      _fbb,
      service_name__);
}
...
inline flatbuffers::Offset<ServiceStop> CreateServiceStopDirect(
    ...
    bool restart = false) {
  auto service_name__ = service_name ? _fbb.CreateString(service_name) : 0;
  return nanoapi::CreateServiceStop(
      _fbb,
      service_name__,
      restart);
}
...
struct TopicServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.TopicServiceStopT";
  }
...
struct TopicServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.TopicServiceStop";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_UNSUBSCRIBE = 4
  };
...
struct EventServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.EventServiceStopT";
  }
};
...
struct EventServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.EventServiceStop";
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           verifier.EndTable();
...
struct TopicConfirmationT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.TopicConfirmationT";
  }
  bool unsubscribe = false;
  std::unique_ptr<nanoapi::TopicConfirmationOptionsT> options{};
};
...
struct TopicConfirmation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.TopicConfirmation";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_UNSUBSCRIBE = 4,
    VT_OPTIONS = 6
  ...
  const nanoapi::TopicConfirmationOptions *options() const {
    return GetPointer<const nanoapi::TopicConfirmationOptions *>(VT_OPTIONS);
  }
  nanoapi::TopicConfirmationOptions *mutable_options() {
    return GetPointer<nanoapi::TopicConfirmationOptions *>(VT_OPTIONS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_UNSUBSCRIBE) &&
...
struct TopicConfirmationBuilder {
  ...
  void add_options(flatbuffers::Offset<nanoapi::TopicConfirmationOptions> options) {
...
inline flatbuffers::Offset<TopicConfirmation> CreateTopicConfirmation(
    flatbuffers::FlatBufferBuilder &_fbb,
    bool unsubscribe = false,
    flatbuffers::Offset<nanoapi::TopicConfirmationOptions> options = 0) {
...
struct TopicConfirmationOptionsT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.TopicConfirmationOptionsT";
  }
  nanoapi::TopicConfirmationTypeFilter confirmation_type_filter = nanoapi::TopicConfirmationTypeFilter_all;
...
struct TopicConfirmationOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.TopicConfirmationOptions";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
  ...
  nanoapi::TopicConfirmationTypeFilter confirmation_type_filter() const {
    return static_cast<nanoapi::TopicConfirmationTypeFilter>(GetField<int8_t>(VT_CONFIRMATION_TYPE_FILTER, 0));
  }
  bool mutate_confirmation_type_filter(nanoapi::TopicConfirmationTypeFilter _confirmation_type_filter) {
...
struct TopicConfirmationOptionsBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_confirmation_type_filter(nanoapi::TopicConfirmationTypeFilter confirmation_type_filter) {
...
inline flatbuffers::Offset<TopicConfirmationOptions> CreateTopicConfirmationOptionsDirect(
  ...
  return nanoapi::CreateTopicConfirmationOptions(
      _fbb,
...
struct EventConfirmationT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.EventConfirmationT";
  }
  nanoapi::TopicConfirmationType confirmation_type = nanoapi::TopicConfirmationType_active_quorum;
  std::string account{};
  std::string amount{};
  std::string hash{};
  nanoapi::BlockUnion block{};
  std::unique_ptr<nanoapi::ElectionInfoT> election_info{};
};
...
struct EventConfirmation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.EventConfirmation";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
  ...
  nanoapi::TopicConfirmationType confirmation_type() const {
    return static_cast<nanoapi::TopicConfirmationType>(GetField<int8_t>(VT_CONFIRMATION_TYPE, 0));
  }
  bool mutate_confirmation_type(nanoapi::TopicConfirmationType _confirmation_type) {
  ...
  const nanoapi::ElectionInfo *election_info() const {
    return GetPointer<const nanoapi::ElectionInfo *>(VT_ELECTION_INFO);
  }
  nanoapi::ElectionInfo *mutable_election_info() {
    return GetPointer<nanoapi::ElectionInfo *>(VT_ELECTION_INFO);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const nanoapi::BlockState *EventConfirmation::block_as<nanoapi::BlockState>() const {
  return block_as_BlockState();
}

template<> inline const nanoapi::BlockOpen *EventConfirmation::block_as<nanoapi::BlockOpen>() const {
  return block_as_BlockOpen();
}

template<> inline const nanoapi::BlockReceive *EventConfirmation::block_as<nanoapi::BlockReceive>() const {
  return block_as_BlockReceive();
}

template<> inline const nanoapi::BlockSend *EventConfirmation::block_as<nanoapi::BlockSend>() const {
  return block_as_BlockSend();
}

template<> inline const nanoapi::BlockChange *EventConfirmation::block_as<nanoapi::BlockChange>() const {
  return block_as_BlockChange();
}
...
struct EventConfirmationBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_confirmation_type(nanoapi::TopicConfirmationType confirmation_type) {
  ...
  void add_election_info(flatbuffers::Offset<nanoapi::ElectionInfo> election_info) {
...
inline flatbuffers::Offset<EventConfirmation> CreateEventConfirmation(
    ...
    nanoapi::Block block_type = nanoapi::Block_NONE,
    flatbuffers::Offset<void> block = 0,
    flatbuffers::Offset<nanoapi::ElectionInfo> election_info = 0) {
...
inline flatbuffers::Offset<EventConfirmation> CreateEventConfirmationDirect(
  ...
  auto hash__ = hash ? _fbb.CreateString(hash) : 0;
  return nanoapi::CreateEventConfirmation(
      _fbb,
      confirmation_type,
      account__,
      amount__,
...
inline flatbuffers::Offset<ElectionInfo> CreateElectionInfoDirect(
  ...
  return nanoapi::CreateElectionInfo(
      _fbb,
      duration,
      time,
      tally__,
...
struct EnvelopeT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "nanoapi.EnvelopeT";
  }
  uint64_t time = 0;
  std::string credentials{};
  std::string correlation_id{};
  nanoapi::MessageUnion message{};
};
...
struct Envelope FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  nanoapi::Message message_type() const {
    return static_cast<nanoapi::Message>(GetField<uint8_t>(VT_MESSAGE_TYPE, 0));
  }
  const void *message() const {
    return GetPointer<const void *>(VT_MESSAGE);
  }
  template<typename T> const T *message_as() const;
  const nanoapi::Error *message_as_Error() const {
    return message_type() == nanoapi::Message_Error ? static_cast<const nanoapi::Error *>(message()) : nullptr;
  }
  const nanoapi::Success *message_as_Success() const {
    return message_type() == nanoapi::Message_Success ? static_cast<const nanoapi::Success *>(message()) : nullptr;
  }
  const nanoapi::IsAlive *message_as_IsAlive() const {
    return message_type() == nanoapi::Message_IsAlive ? static_cast<const nanoapi::IsAlive *>(message()) : nullptr;
  }
  const nanoapi::EventAck *message_as_EventAck() const {
    return message_type() == nanoapi::Message_EventAck ? static_cast<const nanoapi::EventAck *>(message()) : nullptr;
  }
  const nanoapi::BlockInfo *message_as_BlockInfo() const {
    return message_type() == nanoapi::Message_BlockInfo ? static_cast<const nanoapi::BlockInfo *>(message()) : nullptr;
  }
  const nanoapi::AccountWeight *message_as_AccountWeight() const {
    return message_type() == nanoapi::Message_AccountWeight ? static_cast<const nanoapi::AccountWeight *>(message()) : nullptr;
  }
  const nanoapi::AccountWeightResponse *message_as_AccountWeightResponse() const {
    return message_type() == nanoapi::Message_AccountWeightResponse ? static_cast<const nanoapi::AccountWeightResponse *>(message()) : nullptr;
  }
  const nanoapi::TopicConfirmation *message_as_TopicConfirmation() const {
    return message_type() == nanoapi::Message_TopicConfirmation ? static_cast<const nanoapi::TopicConfirmation *>(message()) : nullptr;
  }
  const nanoapi::EventConfirmation *message_as_EventConfirmation() const {
    return message_type() == nanoapi::Message_EventConfirmation ? static_cast<const nanoapi::EventConfirmation *>(message()) : nullptr;
  }
  const nanoapi::ServiceRegister *message_as_ServiceRegister() const {
    return message_type() == nanoapi::Message_ServiceRegister ? static_cast<const nanoapi::ServiceRegister *>(message()) : nullptr;
  }
  const nanoapi::ServiceStop *message_as_ServiceStop() const {
    return message_type() == nanoapi::Message_ServiceStop ? static_cast<const nanoapi::ServiceStop *>(message()) : nullptr;
  }
  const nanoapi::TopicServiceStop *message_as_TopicServiceStop() const {
    return message_type() == nanoapi::Message_TopicServiceStop ? static_cast<const nanoapi::TopicServiceStop *>(message()) : nullptr;
  }
  const nanoapi::EventServiceStop *message_as_EventServiceStop() const {
    return message_type() == nanoapi::Message_EventServiceStop ? static_cast<const nanoapi::EventServiceStop *>(message()) : nullptr;
  }
...
template<> inline const nanoapi::Error *Envelope::message_as<nanoapi::Error>() const {
  return message_as_Error();
}

template<> inline const nanoapi::Success *Envelope::message_as<nanoapi::Success>() const {
  return message_as_Success();
}

template<> inline const nanoapi::IsAlive *Envelope::message_as<nanoapi::IsAlive>() const {
  return message_as_IsAlive();
}

template<> inline const nanoapi::EventAck *Envelope::message_as<nanoapi::EventAck>() const {
  return message_as_EventAck();
}

template<> inline const nanoapi::BlockInfo *Envelope::message_as<nanoapi::BlockInfo>() const {
  return message_as_BlockInfo();
}

template<> inline const nanoapi::AccountWeight *Envelope::message_as<nanoapi::AccountWeight>() const {
  return message_as_AccountWeight();
}

template<> inline const nanoapi::AccountWeightResponse *Envelope::message_as<nanoapi::AccountWeightResponse>() const {
  return message_as_AccountWeightResponse();
}

template<> inline const nanoapi::TopicConfirmation *Envelope::message_as<nanoapi::TopicConfirmation>() const {
  return message_as_TopicConfirmation();
}

template<> inline const nanoapi::EventConfirmation *Envelope::message_as<nanoapi::EventConfirmation>() const {
  return message_as_EventConfirmation();
}

template<> inline const nanoapi::ServiceRegister *Envelope::message_as<nanoapi::ServiceRegister>() const {
  return message_as_ServiceRegister();
}

template<> inline const nanoapi::ServiceStop *Envelope::message_as<nanoapi::ServiceStop>() const {
  return message_as_ServiceStop();
}

template<> inline const nanoapi::TopicServiceStop *Envelope::message_as<nanoapi::TopicServiceStop>() const {
  return message_as_TopicServiceStop();
}

template<> inline const nanoapi::EventServiceStop *Envelope::message_as<nanoapi::EventServiceStop>() const {
...
struct EnvelopeBuilder {
  ...
  void add_message_type(nanoapi::Message message_type) {
...
inline flatbuffers::Offset<Envelope> CreateEnvelope(
    ...
    nanoapi::Message message_type = nanoapi::Message_NONE,
...
inline void BlockInfo::UnPackTo(BlockInfoT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = block(); if (_e) _o->block.value = nanoapi::BlockUnion::UnPack(_e, block_type(), _resolver); }
}
...
inline flatbuffers::Offset<BlockInfo> CreateBlockInfo(flatbuffers::FlatBufferBuilder &_fbb, const BlockInfoT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return nanoapi::CreateBlockInfo(
      _fbb,
      _block_type,
      _block);
}
...
inline flatbuffers::Offset<TopicServiceStop> CreateTopicServiceStop(flatbuffers::FlatBufferBuilder &_fbb, const TopicServiceStopT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return nanoapi::CreateTopicServiceStop(
      _fbb,
      _unsubscribe);
}
...
inline flatbuffers::Offset<EventServiceStop> CreateEventServiceStop(flatbuffers::FlatBufferBuilder &_fbb, const EventServiceStopT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return nanoapi::CreateEventServiceStop(
      _fbb);
}
...
inline void TopicConfirmation::UnPackTo(TopicConfirmationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = unsubscribe(); _o->unsubscribe = _e; }
  { auto _e = options(); if (_e) _o->options = std::unique_ptr<nanoapi::TopicConfirmationOptionsT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TopicConfirmation> CreateTopicConfirmation(flatbuffers::FlatBufferBuilder &_fbb, const TopicConfirmationT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return nanoapi::CreateTopicConfirmation(
      _fbb,
      _unsubscribe,
      _options);
}
...
inline void EventConfirmation::UnPackTo(EventConfirmationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = block_type(); _o->block.type = _e; }
  { auto _e = block(); if (_e) _o->block.value = nanoapi::BlockUnion::UnPack(_e, block_type(), _resolver); }
  { auto _e = election_info(); if (_e) _o->election_info = std::unique_ptr<nanoapi::ElectionInfoT>(_e->UnPack(_resolver)); }
}
...
inline void Envelope::UnPackTo(EnvelopeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = message(); if (_e) _o->message.value = nanoapi::MessageUnion::UnPack(_e, message_type(), _resolver); }
}
...
inline bool VerifyBlock(flatbuffers::Verifier &verifier, const void *obj, Block type) {
  switch (type) {
    ...
    case Block_BlockState: {
      auto ptr = reinterpret_cast<const nanoapi::BlockState *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<const nanoapi::BlockOpen *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<const nanoapi::BlockReceive *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<const nanoapi::BlockSend *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<const nanoapi::BlockChange *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> BlockUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Block_BlockState: {
      auto ptr = reinterpret_cast<const nanoapi::BlockStateT *>(value);
      return CreateBlockState(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<const nanoapi::BlockOpenT *>(value);
      return CreateBlockOpen(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<const nanoapi::BlockReceiveT *>(value);
      return CreateBlockReceive(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<const nanoapi::BlockSendT *>(value);
      return CreateBlockSend(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<const nanoapi::BlockChangeT *>(value);
...
inline BlockUnion::BlockUnion(const BlockUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case Block_BlockState: {
      value = new nanoapi::BlockStateT(*reinterpret_cast<nanoapi::BlockStateT *>(u.value));
      break;
    }
    case Block_BlockOpen: {
      value = new nanoapi::BlockOpenT(*reinterpret_cast<nanoapi::BlockOpenT *>(u.value));
      break;
    }
    case Block_BlockReceive: {
      value = new nanoapi::BlockReceiveT(*reinterpret_cast<nanoapi::BlockReceiveT *>(u.value));
      break;
    }
    case Block_BlockSend: {
      value = new nanoapi::BlockSendT(*reinterpret_cast<nanoapi::BlockSendT *>(u.value));
      break;
    }
    case Block_BlockChange: {
      value = new nanoapi::BlockChangeT(*reinterpret_cast<nanoapi::BlockChangeT *>(u.value));
      break;
    }
    default:
      break;
...
inline void BlockUnion::Reset() {
  switch (type) {
    case Block_BlockState: {
      auto ptr = reinterpret_cast<nanoapi::BlockStateT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<nanoapi::BlockOpenT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<nanoapi::BlockReceiveT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<nanoapi::BlockSendT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<nanoapi::BlockChangeT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline bool VerifyMessage(flatbuffers::Verifier &verifier, const void *obj, Message type) {
  switch (type) {
    ...
    case Message_Error: {
      auto ptr = reinterpret_cast<const nanoapi::Error *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<const nanoapi::Success *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<const nanoapi::IsAlive *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<const nanoapi::EventAck *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<const nanoapi::BlockInfo *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<const nanoapi::AccountWeight *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<const nanoapi::AccountWeightResponse *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<const nanoapi::TopicConfirmation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<const nanoapi::EventConfirmation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<const nanoapi::ServiceRegister *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<const nanoapi::ServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<const nanoapi::TopicServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<const nanoapi::EventServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> MessageUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Message_Error: {
      auto ptr = reinterpret_cast<const nanoapi::ErrorT *>(value);
      return CreateError(_fbb, ptr, _rehasher).Union();
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<const nanoapi::SuccessT *>(value);
      return CreateSuccess(_fbb, ptr, _rehasher).Union();
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<const nanoapi::IsAliveT *>(value);
      return CreateIsAlive(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<const nanoapi::EventAckT *>(value);
      return CreateEventAck(_fbb, ptr, _rehasher).Union();
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<const nanoapi::BlockInfoT *>(value);
      return CreateBlockInfo(_fbb, ptr, _rehasher).Union();
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<const nanoapi::AccountWeightT *>(value);
      return CreateAccountWeight(_fbb, ptr, _rehasher).Union();
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<const nanoapi::AccountWeightResponseT *>(value);
      return CreateAccountWeightResponse(_fbb, ptr, _rehasher).Union();
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<const nanoapi::TopicConfirmationT *>(value);
      return CreateTopicConfirmation(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<const nanoapi::EventConfirmationT *>(value);
      return CreateEventConfirmation(_fbb, ptr, _rehasher).Union();
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<const nanoapi::ServiceRegisterT *>(value);
      return CreateServiceRegister(_fbb, ptr, _rehasher).Union();
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<const nanoapi::ServiceStopT *>(value);
      return CreateServiceStop(_fbb, ptr, _rehasher).Union();
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<const nanoapi::TopicServiceStopT *>(value);
      return CreateTopicServiceStop(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<const nanoapi::EventServiceStopT *>(value);
...
inline MessageUnion::MessageUnion(const MessageUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case Message_Error: {
      value = new nanoapi::ErrorT(*reinterpret_cast<nanoapi::ErrorT *>(u.value));
      break;
    }
    case Message_Success: {
      value = new nanoapi::SuccessT(*reinterpret_cast<nanoapi::SuccessT *>(u.value));
      break;
    }
    case Message_IsAlive: {
      value = new nanoapi::IsAliveT(*reinterpret_cast<nanoapi::IsAliveT *>(u.value));
      break;
    }
    case Message_EventAck: {
      value = new nanoapi::EventAckT(*reinterpret_cast<nanoapi::EventAckT *>(u.value));
      break;
    }
    case Message_BlockInfo: {
      value = new nanoapi::BlockInfoT(*reinterpret_cast<nanoapi::BlockInfoT *>(u.value));
      break;
    }
    case Message_AccountWeight: {
      value = new nanoapi::AccountWeightT(*reinterpret_cast<nanoapi::AccountWeightT *>(u.value));
      break;
    }
    case Message_AccountWeightResponse: {
      value = new nanoapi::AccountWeightResponseT(*reinterpret_cast<nanoapi::AccountWeightResponseT *>(u.value));
      break;
    }
    case Message_TopicConfirmation: {
      FLATBUFFERS_ASSERT(false);  // nanoapi::TopicConfirmationT not copyable.
      break;
    }
    case Message_EventConfirmation: {
      FLATBUFFERS_ASSERT(false);  // nanoapi::EventConfirmationT not copyable.
      break;
    }
    case Message_ServiceRegister: {
      value = new nanoapi::ServiceRegisterT(*reinterpret_cast<nanoapi::ServiceRegisterT *>(u.value));
      break;
    }
    case Message_ServiceStop: {
      value = new nanoapi::ServiceStopT(*reinterpret_cast<nanoapi::ServiceStopT *>(u.value));
      break;
    }
    case Message_TopicServiceStop: {
      value = new nanoapi::TopicServiceStopT(*reinterpret_cast<nanoapi::TopicServiceStopT *>(u.value));
      break;
    }
    case Message_EventServiceStop: {
      value = new nanoapi::EventServiceStopT(*reinterpret_cast<nanoapi::EventServiceStopT *>(u.value));
      break;
    }
    default:
      break;
...
inline void MessageUnion::Reset() {
  switch (type) {
    case Message_Error: {
      auto ptr = reinterpret_cast<nanoapi::ErrorT *>(value);
      delete ptr;
      break;
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<nanoapi::SuccessT *>(value);
      delete ptr;
      break;
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<nanoapi::IsAliveT *>(value);
      delete ptr;
      break;
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<nanoapi::EventAckT *>(value);
      delete ptr;
      break;
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<nanoapi::BlockInfoT *>(value);
      delete ptr;
      break;
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<nanoapi::AccountWeightT *>(value);
      delete ptr;
      break;
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<nanoapi::AccountWeightResponseT *>(value);
      delete ptr;
      break;
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<nanoapi::TopicConfirmationT *>(value);
      delete ptr;
      break;
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<nanoapi::EventConfirmationT *>(value);
      delete ptr;
      break;
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<nanoapi::ServiceRegisterT *>(value);
      delete ptr;
      break;
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<nanoapi::ServiceStopT *>(value);
      delete ptr;
      break;
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<nanoapi::TopicServiceStopT *>(value);
      delete ptr;
      break;
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<nanoapi::EventServiceStopT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline const flatbuffers::TypeTable *BlockTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    nanoapi::BlockStateTypeTable,
    nanoapi::BlockOpenTypeTable,
    nanoapi::BlockReceiveTypeTable,
    nanoapi::BlockSendTypeTable,
    nanoapi::BlockChangeTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "BlockState",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeFilterTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    nanoapi::TopicConfirmationTypeFilterTypeTable
  };
  static const char * const names[] = {
    "all",
    "active",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    nanoapi::TopicConfirmationTypeTypeTable
  };
  static const char * const names[] = {
    "active_quorum",
    "active_confirmation_height",
...
inline const flatbuffers::TypeTable *MessageTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    nanoapi::ErrorTypeTable,
    nanoapi::SuccessTypeTable,
    nanoapi::IsAliveTypeTable,
    nanoapi::EventAckTypeTable,
    nanoapi::BlockInfoTypeTable,
    nanoapi::AccountWeightTypeTable,
    nanoapi::AccountWeightResponseTypeTable,
    nanoapi::TopicConfirmationTypeTable,
    nanoapi::EventConfirmationTypeTable,
    nanoapi::ServiceRegisterTypeTable,
    nanoapi::ServiceStopTypeTable,
    nanoapi::TopicServiceStopTypeTable,
    nanoapi::EventServiceStopTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "Error",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    nanoapi::TopicConfirmationOptionsTypeTable
  };
  static const char * const names[] = {
    "unsubscribe",
    "options"
...
inline const nanoapi::Envelope *GetEnvelope(const void *buf) {
  return flatbuffers::GetRoot<nanoapi::Envelope>(buf);
}

inline const nanoapi::Envelope *GetSizePrefixedEnvelope(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<nanoapi::Envelope>(buf);
}
...
inline bool VerifyEnvelopeBuffer(
  ...
  return verifier.VerifyBuffer<nanoapi::Envelope>(nullptr);
}

inline bool VerifySizePrefixedEnvelopeBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<nanoapi::Envelope>(nullptr);
}

inline void FinishEnvelopeBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<nanoapi::Envelope> root) {
  fbb.Finish(root);
}
...
inline std::unique_ptr<nanoapi::EnvelopeT> UnPackEnvelope(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<nanoapi::EnvelopeT>(GetEnvelope(buf)->UnPack(res));
}

inline std::unique_ptr<nanoapi::EnvelopeT> UnPackSizePrefixedEnvelope(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<nanoapi::EnvelopeT>(GetSizePrefixedEnvelope(buf)->UnPack(res));
}

}  // namespace nanoapi

#endif  // FLATBUFFERS_GENERATED_NANOAPI_NANOAPI_H_
