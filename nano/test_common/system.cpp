...
nano::uint128_t nano::test::system::minimum_principal_weight () const
{
	nano::node_config config;
	return config.online_weight_minimum.number () / config.network_params.network.principal_weight_factor;
}
