...
namespace
{
nano::keypair setup_rep (nano::system & system, nano::node & node, nano::uint128_t amount)
{
...
std::vector<nano::keypair> setup_reps (nano::system & system, nano::node & node, int count)
{
 ...
 */
std::vector<std::shared_ptr<nano::block>> setup_blocks (nano::system & system, nano::node & node, int count)
{
	auto latest = node.latest (nano::dev::genesis_key.pub);
	auto balance = node.balance (nano::dev::genesis_key.pub);
