...
public:
	...
	std::chrono::milliseconds merge_period{ 250ms };
	std::chrono::milliseconds merge_cached_period{ 1s };
	/** How often to send keepalive messages */
	std::chrono::seconds keepalive_period{ 15s };
