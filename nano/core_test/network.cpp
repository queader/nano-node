...
TEST (tcp_listener, tcp_node_id_handshake)
{
	...
	nano::message::node_id_handshake node_id_handshake{ nano::dev::network_params.network, cookie, boost::none };
	...
	nano::message::node_id_handshake node_id_handshake_response{ nano::dev::network_params.network, boost::none, response_zero };
