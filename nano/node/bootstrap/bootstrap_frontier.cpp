...
{
	nano::message::frontier_req request{ connection->node->network_params.network };
...
nano::frontier_req_server::frontier_req_server (std::shared_ptr<nano::transport::tcp_server> const & connection_a, std::unique_ptr<nano::message::frontier_req> request_a) :
	connection (connection_a),
