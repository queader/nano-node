...
nano::error nano::bootstrap_config::deserialize (nano::tomlconfig & toml)
{
	...
	toml.get ("throttle_size_coefficient", throttle_size_coefficient);
	toml.get ("throttling_rate", throttling_rate);
...
nano::error nano::bootstrap_config::serialize (nano::tomlconfig & toml) const
{
	...
	toml.put ("throttle_size_coefficient", throttle_size_coefficient, "Scales the number of samples to track for bootstrap throttling.\ntype:uint64");
	toml.put ("throttling_rate", throttling_rate, "When bootstrap is warmed up, request are throttled by this factor to avoid unnecessary requests.\ntype:uint64");
