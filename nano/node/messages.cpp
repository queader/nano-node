...
nano::message::header::header (nano::network_constants const & constants, nano::message::type type_a) :
...
nano::message::header::header (bool & error_a, nano::stream & stream_a)
{
	if (!error_a)
	{
...
void nano::message::header::serialize (nano::stream & stream_a) const
{
...
bool nano::message::header::deserialize (nano::stream & stream_a)
{
	auto error (false);
	try
	{
...
std::string nano::to_string (nano::message::type type)
{
	switch (type)
	{
		case nano::message::type::invalid:
			return "invalid";
		case nano::message::type::not_a_type:
			return "not_a_type";
...
nano::stat::detail nano::to_stat_detail (nano::message::type type)
{
	switch (type)
	{
		case nano::message::type::invalid:
...
std::string nano::message::header::to_string () const
{
...
void nano::message::header::flag_set (uint8_t flag_a)
{
...
bool nano::message::header::bulk_pull_is_count_present () const
{
	auto result (false);
	if (type == nano::message::type::bulk_pull)
	{
...
bool nano::message::header::bulk_pull_ascending () const
{
	auto result (false);
	if (type == nano::message::type::bulk_pull)
	{
...
bool nano::message::header::frontier_req_is_only_confirmed_present () const
{
	auto result (false);
	if (type == nano::message::type::frontier_req)
	{
...
bool nano::message::header::node_id_handshake_is_query () const
{
	auto result (false);
	if (type == nano::message::type::node_id_handshake)
	{
...
bool nano::message::header::node_id_handshake_is_response () const
{
	auto result (false);
	if (type == nano::message::type::node_id_handshake)
	{
...
std::size_t nano::message::header::payload_length_bytes () const
{
	switch (type)
	{
		case nano::message::type::bulk_pull:
		...
		case nano::message::type::asc_pull_ack:
		{
			return nano::message::asc_pull_ack::size (*this);
		}
		default:
		{
			debug_assert (false);
...
bool nano::message::header::is_valid_message_type () const
{
	switch (type)
	{
		case nano::message::type::bulk_pull:
...
nano::message::message::message (nano::network_constants const & constants, nano::message::type type_a) :
	header (constants, type_a)
{
}

nano::message::message::message (nano::message::header const & header_a) :
	header (header_a)
{
}

std::shared_ptr<std::vector<uint8_t>> nano::message::message::to_bytes () const
{
...
nano::shared_const_buffer nano::message::message::to_shared_const_buffer () const
{
	return shared_const_buffer (to_bytes ());
}

nano::message::type nano::message::message::type () const
{
	return header.type;
}
...
nano::message::telemetry_ack::telemetry_ack (nano::network_constants const & constants, nano::message::telemetry_data const & telemetry_data_a) :
	message (constants, nano::message::type::telemetry_ack),
...
void nano::message::telemetry_data::deserialize (nano::stream & stream_a, uint16_t payload_length_a)
{
...
void nano::message::telemetry_data::serialize_without_signature (nano::stream & stream_a) const
{
...
void nano::message::telemetry_data::serialize (nano::stream & stream_a) const
{
	write (stream_a, signature);
	serialize_without_signature (stream_a);
}

nano::error nano::message::telemetry_data::serialize_json (nano::jsonconfig & json, bool ignore_identification_metrics_a) const
{
...
nano::error nano::message::telemetry_data::deserialize_json (nano::jsonconfig & json, bool ignore_identification_metrics_a)
{
	if (!ignore_identification_metrics_a)
	{
...
std::string nano::message::telemetry_data::to_string () const
{
	nano::jsonconfig jc;
...
bool nano::message::telemetry_data::operator== (nano::message::telemetry_data const & data_a) const
{
...
void nano::message::telemetry_data::sign (nano::keypair const & node_id_a)
{
...
bool nano::message::telemetry_data::validate_signature () const
{
	std::vector<uint8_t> bytes;
	{
		nano::vectorstream stream (bytes);
	...
	response (response)
{
	if (query)
	{
		header.flag_set (nano::message::header::node_id_handshake_query_flag);
	}
	if (response)
	{
		header.flag_set (nano::message::header::node_id_handshake_response_flag);
	}
}
...
nano::message::asc_pull_ack::asc_pull_ack (const nano::network_constants & constants) :
	message (constants, nano::message::type::asc_pull_ack)
{
}

nano::message::asc_pull_ack::asc_pull_ack (bool & error, nano::stream & stream, const nano::message::header & header) :
	message (header)
{
	error = deserialize (stream);
}
...
void nano::message::asc_pull_ack::serialize (nano::stream & stream) const
{
...
bool nano::message::asc_pull_ack::deserialize (nano::stream & stream)
{
	debug_assert (header.type == nano::message::type::asc_pull_ack);
	bool error = false;
	try
	{
		nano::read (stream, type);
...
void nano::message::asc_pull_ack::serialize_payload (nano::stream & stream) const
{
	debug_assert (verify_consistency ());
...
void nano::message::asc_pull_ack::deserialize_payload (nano::stream & stream)
{
	switch (type)
	{
		case asc_pull_type::blocks:
...
void nano::message::asc_pull_ack::update_header ()
{
	std::vector<uint8_t> bytes;
	{
		nano::vectorstream payload_stream (bytes);
...
std::size_t nano::message::asc_pull_ack::size (const nano::message::header & header)
{
	uint16_t payload_length = nano::narrow_cast<uint16_t> (header.extensions.to_ulong ());
	return partial_size + payload_length;
}

bool nano::message::asc_pull_ack::verify_consistency () const
{
	struct consistency_visitor
	{
		nano::asc_pull_type type;
...
void nano::message::asc_pull_ack::blocks_payload::serialize (nano::stream & stream) const
{
...
void nano::message::asc_pull_ack::blocks_payload::deserialize (nano::stream & stream)
{
...
void nano::message::asc_pull_ack::account_info_payload::serialize (nano::stream & stream) const
{
...
void nano::message::asc_pull_ack::account_info_payload::deserialize (nano::stream & stream)
{
