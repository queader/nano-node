...
nano::ptree nano::election::collect_info () const
{
	...
	for (auto & info : votes)
	{
		...
		entry.put ("time", nano::to_millis (info.time));
	...
	result.put ("start_time", nano::to_millis (election_start));
	result.put ("state_start_time", nano::to_millis (election_start));
	result.put ("last_update_time", nano::to_millis (last_update));
	result.put ("last_block_broadcast_time", nano::to_millis (last_block));
	result.put ("last_confirmation_request_time", nano::to_millis (last_req));
	result.put ("last_vote_broadcast_time", nano::to_millis (last_vote));
