...
void nano::wallets::ongoing_compute_reps ()
{
	...
	auto compute_delay = network_params.network.is_dev_network () ? std::chrono::milliseconds (10) : (network_params.network.is_test_network () ? std::chrono::seconds (1) : std::chrono::minutes (15));
