...
nano::message::telemetry_data nano::node::local_telemetry () const
{
	...
	telemetry_data.maker = static_cast<std::underlying_type_t<nano::message::telemetry_maker>> (ledger.pruning ? nano::message::telemetry_maker::nf_pruned_node : nano::message::telemetry_maker::nf_node);
