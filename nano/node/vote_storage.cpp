...
{
	auto maybe_account = ledger.account (ledger_transaction, hash);
	if (!maybe_account)
	{
		return {};
	}
	auto account = maybe_account.value ();

	auto maybe_account_info = ledger.account_info (ledger_transaction, account);
