...
nano::recently_cemented::recently_cemented (std::size_t max_size_a) :
	max_size{ max_size_a }
{
}

void nano::recently_cemented::put (const nano::election_status & status)
{
	nano::lock_guard<nano::mutex> guard{ mutex };
...
nano::recently_cemented::queue_t nano::recently_cemented::list () const
{
	nano::lock_guard<nano::mutex> guard{ mutex };
	return cemented;
}

std::size_t nano::recently_cemented::size () const
{
	nano::lock_guard<nano::mutex> guard{ mutex };
