...
namespace transport
{
	...
	public:
		...
		bool insert (std::shared_ptr<nano::transport::channel_tcp> const &, std::shared_ptr<nano::socket> const &, std::shared_ptr<nano::network_server> const &);
	...
	private:
		...
		public:
			...
			std::shared_ptr<nano::socket> socket;
			std::shared_ptr<nano::network_server> response_server;
			channel_tcp_wrapper (std::shared_ptr<nano::transport::channel_tcp> channel_a, std::shared_ptr<nano::socket> socket_a, std::shared_ptr<nano::network_server> server_a) :
