...
void nano::transport::message_deserializer::received_message (nano::message::header header, std::size_t payload_size, const nano::transport::message_deserializer::callback_type && callback)
{
